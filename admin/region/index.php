                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-4">
                                                <a href="<?php echo BASE_URL . '/admin/region/create.php' ?>" class="btn btn-danger mb-2">
                                                    <i class="mdi mdi-plus-circle mr-2"></i> Add Region
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($regions as $key => $region): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit.php?id=<?php echo $region['id']; ?>" class="action-icon"> 
                                                                <i class="mdi mdi-square-edit-outline"></i>
                                                            </a>

                                                            <a href="index.php?del_id=<?php echo $region['id']; ?>" class="action-icon" style="color: red;"> 
