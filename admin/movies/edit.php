                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="card-box">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" id="movie-description" name="description" rows="4" placeholder="Please enter description ... ">
                                ...
                                <div class="col-6">
                                    <div class="text-center mb-3">
                                        <button type="submit" name="editmovie" class="btn w-sm btn-success waves-effect waves-light">Save</button>
                                    </div>
                                </div> <!-- end col -->
                            </div>
                            <!-- end row -->
